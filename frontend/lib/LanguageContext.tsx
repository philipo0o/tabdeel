...
const translations = {
  ar: {
    ...
    address: 'العنوان',
    addressValue: '31 غيط العدة، رحبة عابدين، عابدين، محافظة القاهرة 4281088، رحبة عابدين، مصر',
    phone: 'الهاتف',
    phoneValue: '+966 12 345 6789',
    email: 'البريد الإلكتروني',
    emailValue: 'tabdeel.eg@gmail.com',
  ...
  en: {
    ...
    address: 'Address',
    addressValue: '31 Gheet Al Eda, Rahbet Abdin, Abdeen, Cairo Governorate 4281088, Rahbet Abdeen, Egypt',
    phone: 'Phone',
    phoneValue: '+966 12 345 6789',
    email: 'Email',
    emailValue: 'tabdeel.eg@gmail.com',
